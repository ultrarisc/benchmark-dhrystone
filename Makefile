CC = /home/toolchain/urgcc-3.11/linux/bin/riscv64-unknown-linux-gnu-gcc 
DHRY-LFLAGS =
...
override CFLAGS += $(DHRY-CFLAGS) $(XCFLAGS) -Xlinker --defsym=__stack_size=0x800 -Xlinker --defsym=__heap_size=0x1000 -static
